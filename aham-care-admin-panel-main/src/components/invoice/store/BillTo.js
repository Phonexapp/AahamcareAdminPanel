  ...
  return (
    <Paper sx={{ mt: 3 }}>
      <Stack sx={{ p:3, borderTop:"1px solid black", borderBottom:"1px solid black"}} direction="row" justifyContent="space-between" alignItems="flex-start" spacing={2}>
        ...
        <Box>
            <Typography sx={{color:"#da1b76"}} variant='subtitle1'>Payment Details:</Typography>
            <Typography variant='subtitle2'>Date: <b>{date}</b></Typography>
            <Typography variant='subtitle2'>Payment Id: <b>{item?.paymentId}</b></Typography>
        ...
        <Box>
          ...
          <Typography variant='subtitle2'><b>{item?.invoiceNo}</b> </Typography>
          <Typography variant='subtitle2'>Store Item:</Typography>
          <Typography variant='subtitle2'> <b>{item?.storeId?.item}</b></Typography>
