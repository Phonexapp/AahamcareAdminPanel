...
import { REQUIREMENT_HEAD } from '../table/TableHead';

function RequirementTable({ oldageHome }) {
  const rows = oldageHome.requirement.requirement;
  ...
  const headCells = REQUIREMENT_HEAD;
        ...
        <Paper sx={{ width: '100%', mb: 2 }}>
          ...
          <TableContainer>
            <Table sx={{ minWidth: 750 }} aria-labelledby="tableTitle" size={dense ? 'small' : 'medium'}>
              ...
              />
              <TableBody onClick={() => console.log('Id=>', oldageHome._id)}>
                {visibleRows
                      ...
                      return (
                        ...
                        >
                          ...
                          <TableCell align="left">
                            {row.requirement} {row.requirementUnit}
                          </TableCell>

                          <TableCell align="left">{row.price}</TableCell>
                          <TableCell align="left">
                            {row.needs} {row.requirementUnit}
                          </TableCell>
                        </TableRow>
                      );
                    })
...
export default  React.memo(RequirementTable); 
